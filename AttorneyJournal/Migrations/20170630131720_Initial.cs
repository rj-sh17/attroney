        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttorneyUserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToAttorneyId = table.Column<Guid>(nullable: true, defaultValue: new Guid("58ceafa0-9ad9-468d-a16b-4ec8f2944d6f"))
                        .Annotation("MySql:ValueGeneratedOnAdd", true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    DateOfAccident = table.Column<DateTime>(nullable: true)
                        .Annotation("MySql:ValueGeneratedOnAdd", true),
                    ...
                    ProfilePictureKey = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Attorneys_AssignedToAttorneyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false)
                        .Annotation("MySql:ValueGeneratedOnAdd", true),
                    AmazonObjectKey = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AssignedToAttorneyId",
                table: "AspNetUsers",
